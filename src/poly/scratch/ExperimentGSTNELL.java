...
public class ExperimentGSTNELL {
	...
	public static void main(String[] args) {
		...
		double dataFraction = Double.valueOf(args[6]);
		...
		DataSet<TokenSpansDatum<LabelsList>, LabelsList> data = dataFactory.loadDataSet(nellConfidenceThreshold, dataFraction, true);
