...
public class HRun {
	public static class PolyMapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> extends Mapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {
		protected PolyProperties properties;
		protected PolyDataTools dataTools;
		
		@Override
		protected void setup(Context context) {
			this.properties = new PolyProperties();
			this.dataTools = new PolyDataTools(new OutputWriter(), this.properties);
		}
	}
